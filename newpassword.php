...
<div class="exampsle">
  ...
  <div class="wrapper" style="min-height:608px ; border-radius: 0 60px 60px 60px">
    <section class="form login">
    <header > <svg style="  float: left;  width: 60px; height: auto; margin: 0 15px 0 0  ;"  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path fill="#7F7F7F" d="M324.792,255.601c0,10.455,0,20.713,0,31.259c-0.736,0.09-1.438,0.251-2.141,0.251
 ...
 dtalk <div style="font-weight: 200;"> for dtuites </div></header>    
 
 <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        <div class="error-text"></div>
        <div class="field input">
          <label>Email Address</label>
          <input type="text" name="email" style="font-weight: 200;" placeholder="Registered email" required>
        </div>
        <div class="field input">
          <label>OTP</label>
          <input type="text" name="otp" style="font-weight: 200;" placeholder="Enter OTP send to registered mail" required>
        </div>
        ...
        <div class="field button btn-grad">
          <input type="submit" style="background: transparent; margin: 0 0 0px 0; font-weight:300;" name="submit" value="Verify OTP">
        </div>
      </form>
      <div class="link"> <div style="color: grey;" ><br><br><br><br><br> <a href="index.php">Login</a></div>
<div class="link"> <div style="color: grey;" >or <a href="register.php">Signup</a> to register</div>
          </section>
  </div>
