...
<path fill="#7F7F7F" d="M324.792,255.601c0,10.455,0,20.713,0,31.259c-0.736,0.09-1.438,0.251-2.141,0.251
 ...
 dtalk <div style="font-weight: 200;"> for dtuites </div></header>      <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="field input">
          ...
          <input type="password" name="password" style="font-weight: 200;" placeholder="Password" required>
          <i class="fas fa-eye"></i>
        </div>
        <div class="field button btn-grad">
          <input type="submit" style="background: transparent; margin: 0 0 0px 0; font-weight:300;" name="submit" value="Login">
        </div>
      </form>
      <div class="link"> <div style="color: grey;" >or <a href="register.php">Signup</a> to register</div>
      <div class="link"> <div style="color: grey;" > <br>Forgot Password ? <br> Or <br> Problem in DTU Email Verification Link <br><a href="resetpass.php">Click Here</a></div>
    </section>
  </div>
