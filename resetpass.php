...
<path fill="#7F7F7F" d="M324.792,255.601c0,10.455,0,20.713,0,31.259c-0.736,0.09-1.438,0.251-2.141,0.251
 ...
 <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="field input"><br><br>
          <label>This will also verify your dtu mail id if needed.</label>
          
        </div>
        <div class="field button btn-grad">
          <input type="submit" style="background: transparent; margin: 0 0 0px 0; font-weight:300;" name="submit" value="Send Mail">
        </div>
      </form>
      <div class="link"> <div style="color: grey;" ><br><br>Got OTP? : <a href="newpassword.php">Change Password</a></div>
      
      <div class="link"> <div style="color: grey;" ><br><a href="index.php">Login</a></div>
